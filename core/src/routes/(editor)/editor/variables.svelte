<script>
    import { globalEditorPreferencesStore, globalVisibilityStore, globalRightPanelContentStore, globalLeftPanelContentStore } from "../../globals/globalstores";
...
<div class="flex columns-0 lg:columns-2">
    <div class="">
