<script>
    ...
    */
    ...
    let propertyOptions = [
        ...
        {name: "Auto",      value: "bg-auto",       info: "background-size: auto;"},
        {name: "Cover",     value: "bg-cover",      info: "background-size: cover;"},
        {name: "Contain",   value: "bg-contain",    info: "background-size: contain;"},
...
<div class="w-full flex flex-row flex-grow justify-between h-8 align-middle items-center">
    <span title="Utilities for controlling the background size of an element's background image.">Size</span>
