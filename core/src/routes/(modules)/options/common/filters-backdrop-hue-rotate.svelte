<script>
    ...
    */
    ...
    $: loaded, (()=>{
        if(loaded == true) {// && innerLoad == false
            ...
            elementDataLoaded.split(" ").forEach( cls => {
                ...
                if(currentClass.startsWith("backdrop-hue-rotate")){
                    property = currentClass;
                    sliderValue = parseInt(currentClass.replaceAll("backdrop-hue-rotate-[", "").replaceAll("deg]",""),0);
                    innerLoad = true;
                    foundClass = true;
                }
    ...
    $: property, (()=>{
        if(loaded == true) {
            ...
            classInput.split(" ").forEach( cls => {
                ...
                if(cls.trim().startsWith("backdrop-hue-rotate")){
            ...
            if(property != "backdrop-hue-rotate-[0deg]"){ 
    ...
    function updateSliderValue(newValue){
        property = "backdrop-hue-rotate-[" + newValue.toString() + "deg]";
    }
...
<div class="w-full flex flex-row flex-grow justify-between h-8 align-middle items-center">
    <span title="Utilities for applying backdrop hue-rotate filters to an element.">Backdrop Hue Rotate</span>
