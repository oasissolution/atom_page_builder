<script>
    ...
    */
    ...
    let propertyOptions = [
        ...
        {name: "Backdrop Grayscale-0",   value: "backdrop-grayscale-0",   info: "backdrop-filter: grayscale(0);\nPrevent applying of grayscale filter"},
        {name: "Backdrop Grayscale",     value: "backdrop-grayscale",     info: "backdrop-filter: grayscale(100%);\nApply grayscale filter"},
...
<div class="w-full flex flex-row flex-grow justify-between h-8 align-middle items-center">
    <span title="Utilities for applying backdrop grayscale filters to an element.">Backdrop GrayScale</span>
