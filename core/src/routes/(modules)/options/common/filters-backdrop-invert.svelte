<script>
    ...
    */
    ...
    let propertyOptions = [
        ...
        {name: "Backdrop Invert-0",   value: "backdrop-invert-0",   info: "backdrop-filter: invert(0);\nPrevent applying of backdrop invert filter"},
        {name: "Backdrop Invert",     value: "backdrop-invert",     info: "backdrop-filter: invert(100%);\nApply backdrop invert filter"},
...
<div class="w-full flex flex-row flex-grow justify-between h-8 align-middle items-center">
    <span title="Utilities for applying backdrop invert filters to an element.">Backdrop Invert</span>
