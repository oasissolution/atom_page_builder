<script>
    ...
    */
    ...
    let propertyOptions = [
        ...
        {name: "Backdrop Sepia-0",   value: "backdrop-sepia-0",   info: "backdrop-filter: sepia(0);\nPrevent applying of sepia filter"},
        {name: "Backdrop Sepia",     value: "backdrop-sepia",     info: "backdrop-filter: sepia(100%);\nApply sepia filter"},
...
<div class="w-full flex flex-row flex-grow justify-between h-8 align-middle items-center">
    <span title="Utilities for applying backdrop sepia filters to an element.">Backdrop Sepia</span>
