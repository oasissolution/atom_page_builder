<script>
    ...
    */
    ...
    let propertyOptions = [
        ...
        {name: "Grayscale-0",     value: "grayscale-0",     info: "filter: grayscale(0);\nPrevent applying of grayscale filter"},
        {name: "Grayscale",     value: "grayscale",     info: "filter: grayscale(100%);\nApply grayscale filter"},
...
<div class="w-full flex flex-row flex-grow justify-between h-8 align-middle items-center">
    <span title="Utilities for applying grayscale filters to an element.">GrayScale</span>
