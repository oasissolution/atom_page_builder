<script>
    ...
    */
    ...
    let propertyOptions = [
        ...
        {name: "Invert-0",   value: "invert-0",   info: "filter: invert(0);\nPrevent applying of invert filter"},
        {name: "Invert",     value: "invert",     info: "filter: invert(100%);\nApply invert filter"},
...
<div class="w-full flex flex-row flex-grow justify-between h-8 align-middle items-center">
    <span title="Utilities for applying invert filters to an element.">Invert</span>
