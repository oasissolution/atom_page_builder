<script>
    ...
    */
    ...
    let propertyOptions = [
        ...
        {name: "Sepia-0",   value: "sepia-0",   info: "filter: sepia(0);\nPrevent applying of sepia filter"},
        {name: "Sepia",     value: "sepia",     info: "filter: sepia(100%);\nApply sepia filter"},
...
<div class="w-full flex flex-row flex-grow justify-between h-8 align-middle items-center">
    <span title="Utilities for applying sepia filters to an element.">Sepia</span>
