<script>
    ...
    */
    ...
    let propertyOptions = [
        ...
        {name: "Auto",      value: "auto-rows-auto",    info: "grid-auto-rows: auto;"},
        {name: "Min",       value: "auto-rows-min",     info: "grid-auto-rows: min-content;"},
        {name: "Max",       value: "auto-rows-max",     info: "grid-auto-rows: max-content;"},
        {name: "fr",        value: "auto-rows-fr",      info: "grid-auto-rows: minmax(0, 1fr);"},
...
<div class="w-full flex flex-row flex-grow justify-between h-8 align-middle items-center">
    <span title="Utilities for controlling the size of implicitly-created grid rows.">Grid Auto Rows</span>
