<script>
    ...
    */
    ...
    let propertyOptions = [
        ...
        {name: "Wrap",          value: "flex-wrap",         info: "flex-wrap: wrap;"},
        {name: "Wrap Reverse",  value: "flex-wrap-reverse", info: "flex-wrap: wrap-reverse;"},
        {name: "No Wrap",       value: "flex-nowrap",       info: "flex-wrap: nowrap;"},
...
<div class="w-full flex flex-row flex-grow justify-between h-8 align-middle items-center">
    <span title="Utilities for controlling how flex items wrap.">Flex Wrap</span>
