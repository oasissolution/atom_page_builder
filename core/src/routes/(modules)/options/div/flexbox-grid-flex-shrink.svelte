<script>
    ...
    */
    ...
    let propertyOptions = [
        ...
        {name: "Shrink",      value: "shrink",      info: "flex-shrink: 1;\nUse shrink to allow a flex item to shrink if needed"},
        {name: "shrink 0",    value: "shrink-0",    info: "flex-shrink: 0;\nUse shrink-0 to prevent a flex item from shrinking"},
...
<div class="w-full flex flex-row justify-between h-8 align-middle items-center">
    <span title="Utilities for controlling how flex items shrink.">Flex Shrink</span>
