<script>
    ...
    */
    ...
    let propertyOptions = [
        ...
        {name: "1",        value: "flex-1",        info: "flex: 1 1 0%;\nUse flex-1 to allow a flex item to grow and shrink as needed, ignoring its initial size"},
        {name: "Auto",     value: "flex-auto",     info: "flex: 1 1 auto;\nUse flex-auto to allow a flex item to grow and shrink, taking into account its initial size"},
        {name: "Initial",  value: "flex-initial",  info: "flex: 0 1 auto;\nUse flex-initial to allow a flex item to shrink but not grow, taking into account its initial size"},
        {name: "None",     value: "flex-none",     info: "flex: none;\nUse flex-none to prevent a flex item from growing or shrinking"},
...
<div class="w-full flex flex-row flex-grow justify-between h-8 align-middle items-center">
    <span title="Utilities for controlling how flex items wrap.">Flex</span>
