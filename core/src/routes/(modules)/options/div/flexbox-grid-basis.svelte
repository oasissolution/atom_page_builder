<script>
    ...
    import { basisClassOptions } from "../common/common-constants.svelte";
    ...
    */
     ...
     */
    let propertyOptions = basisClassOptions;
...
<div class="w-full flex flex-row flex-grow justify-between h-8 align-middle items-center">
    <span title="Utilities for controlling the initial size of flex items.">Flex Basis</span>
