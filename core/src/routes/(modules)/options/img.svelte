<script>
	 ...
	 * @property {string} [src] - Specifies an external image source
	 */
	...
	function handleSrcInput(e) {
		if (!e?.key) return false;

		if (e.key === 'Enter') {
			if (activeElement) {
				activeElement.data.src = srcElement.value;
				updateEditor();
			}
		}
	}
...
<div class="widgetPanelSubTitle">Image Options</div>
<div class="h-4" />
...
{#if selectedTabPageIndex == 0}
	...
	<div class="widgetPanelDivider" />
	<p class="text-white">Image Source</p>
	<input
		type="text"
		class="w-full rounded-lg p-2 mb-1"
		placeholder="Paste image link here"
		value={activeElement?.data?.src ?? ''}
		on:keyup={handleSrcInput}
		bind:this={srcElement}
	/>
...
{:else if selectedTabPageIndex == 1}
	...
	{#if collapseDesignSpacing}
		<div class="w-full" in:slide={{ duration: 400 }} out:slide={{ duration: 100 }}>
			...
			<SpacingMargin bind:loaded bind:classInput {elementDataLoaded} on:updateClass={updateClass} />
	...
	{#if collapseDesignBorder}
		<div class="w-full" in:slide={{ duration: 400 }} out:slide={{ duration: 100 }}>
			<BorderWidth bind:loaded bind:classInput {elementDataLoaded} on:updateClass={updateClass} />

			<div class="widgetPanelDivider" />

			<BorderRadius bind:loaded bind:classInput {elementDataLoaded} on:updateClass={updateClass} />

			<div class="widgetPanelDivider" />

			<BorderStyle
				bind:property={borderStyle}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<BorderColor bind:loaded bind:classInput {elementDataLoaded} on:updateClass={updateClass} />
		</div>
	{/if}
	...
	{#if collapseBackground}
		<div class="w-full " in:slide={{ duration: 400 }} out:slide={{ duration: 100 }}>
			...
			<BackgroundAttachment
				bind:property={backgroundAttachment}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<BackgroundOrigin
				bind:property={backgroundOrigin}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<BackgroundPosition
				bind:property={backgroundPosition}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<BackgroundRepeat
				bind:property={backgroundRepeat}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
	...
	{#if collapseDesignEffects}
		<div class="w-full" in:slide={{ duration: 400 }} out:slide={{ duration: 100 }}>
			<EffectsDropShadow
				bind:property={effectsDropShadow}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<EffectsMixBlendMode
				bind:property={effectsMixBlendMode}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<EffectsBackgroundBlendMode
				bind:property={effectsBackgroundBlendMode}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
	...
	{#if collapseDesignFilters}
		<div class="w-full" in:slide={{ duration: 400 }} out:slide={{ duration: 100 }}>
			...
			<FiltersBrightness
				bind:property={filtersBrightness}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<FiltersDropShadow
				bind:property={filtersDropShadow}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<FiltersGrayscale
				bind:property={filtersGrayScale}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<FiltersHueRotate
				bind:property={filtersHueRotate}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<FiltersBackdropBlur
				bind:property={filtersBackdropBlur}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<FiltersBackdropBrightness
				bind:property={filtersBackdropBrightness}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<FiltersBackdropContrast
				bind:property={filtersBackdropContrast}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<FiltersBackdropGrayscale
				bind:property={filtersBackdropGrayscale}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<FiltersBackdropHueRotate
				bind:property={filtersBackdropHueRotate}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<FiltersBackdropInvert
				bind:property={filtersBackdropInvert}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<FiltersBackdropOpacity
				bind:property={filtersBackdropOpacity}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<FiltersBackdropSaturate
				bind:property={filtersBackdropSaturate}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<FiltersBackdropSepia
				bind:property={filtersBackdropSepia}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
	...
	{#if collapseDesignClass}
		<div class="w-full " in:slide={{ duration: 400 }} out:slide={{ duration: 100 }}>
			<div class="mb-1 w-full flex items-end align-bottom place-content-between">
				<span class="">Class</span><span class="text-[10px]">Tailwind CSS</span>
			</div>
			<Textarea bind:text={classInput} on:onSubmit={updateClass} readonly={true} />
...
{:else if selectedTabPageIndex == 2}
	...
	{#if collapseAnimationTransition}
		<div class="w-full " in:slide={{ duration: 400 }} out:slide={{ duration: 100 }}>
			<TransitionProperty
				bind:property={transitionProperty}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<TransitionDuration
				bind:property={transitionDuration}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<TransitionTimingFunction
				bind:property={transitionTimingFunction}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
			...
			<TransitionAnimation
				bind:property={transitionAnimation}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
	...
	{#if collapseAnimationTransform}
		<div class="w-full " in:slide={{ duration: 400 }} out:slide={{ duration: 100 }}>
			<TransformNoTransform
				bind:property={transformNoTransform}
				bind:loaded
				bind:classInput
				{elementDataLoaded}
				on:updateClass={updateClass}
