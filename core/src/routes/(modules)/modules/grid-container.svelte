...
<!-- <div class="w-full h-full z-10 bg-sky-300"></div> -->

<!-- <div class="w-full h-full relative bg-slate-500"></div> -->
...
<div bind:this={bindElement} id="{uuid}" on:mousedown|self={selectElement} on:dblclick={openOptionsPanel} class:blockUserSelect={childs.length == 0} draggable="true">
    ...
    <!-- <div class="bg-slate-500 col-start-1 col-span-12 row-start-1 row-span-6"></div> -->
