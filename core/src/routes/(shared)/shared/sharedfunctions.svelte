...
import { openOptionsPanel, sendDeletedElement, refreshEditorData  } from "../../(shared)/shared/sharedfunctions.js";
...
export function deleteComponent(globalSelectedElementStore, globalComponentCollectionStore){
    if(globalSelectedElementStore != undefined && globalComponentCollectionStore != undefined){
        ...
        console.error("Either 'globalSelectedElementStore' or 'globalComponentCollectionStore' is undefined!");
    }
